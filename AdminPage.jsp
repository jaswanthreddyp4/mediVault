...
<html>
    ...
    <body>
        ...
        <div class="content">
        <form action=adminPageResponse.jsp>
            
            <table>
            <tr><td><h1>ADMIN-LOGIN</h1></td></tr>
                <tr><td><br></td></tr>
            <tr><td style="font-size: 4vh;">Enter Name:</td></tr>
            <tr><td><input type="text" name=adminName placeholder="Name" class="in" required align="center"></td></tr>
            <tr><td><br></td></tr>
            <tr><td style="font-size: 4vh;">Enter Password:</td></tr>
            <tr><td><input type="password" name=adminPassword placeholder="Password" class="in" required align="center"></td></tr>
            <tr><td><br></td></tr>
            <tr>
            <td >
